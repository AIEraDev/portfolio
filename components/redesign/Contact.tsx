        ...
        <div className="space-y-6">
          <div className="space-y-4">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Let's build systems that matter. I'm always interested in discussing new opportunities,
        ...
        <div className="space-y-4">
            ...
            {contactMethods.map((method) => {
              ...
              return (
                <a
                  ...
                  className="group block p-4 rounded-lg border border-border/60 bg-background/50 hover:bg-muted/20 hover:border-accent/30 transition-all duration-200"
                >
                  <div className="flex items-start gap-3">
                    <Icon className="w-5 h-5 text-accent mt-0.5 group-hover:scale-110 transition-transform" />
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-accent font-mono break-all">{method.value}</p>
          ...
          <div className="mt-8 p-4 rounded-lg bg-accent/5 border border-accent/20">
            <p className="text-sm text-muted-foreground">
              <span className="text-accent font-medium">Response time:</span> I typically respond
              within 24-48 hours. For urgent matters, LinkedIn or email work best.
            </p>
          </div>
        </div>
      </div>
