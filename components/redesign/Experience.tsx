      ...
      roles: [
        {
          ...
          description: "Architecting and developing Clypra, a privacy-focused open-source desktop video editor using Tauri, React, Rust, and FFmpeg. Engineering a professional-grade multitrack timeline interface with local FFmpeg processing to provide offline, subscription-free editing."
        }
      ]
    },
    {
    ...
    <section id="experience" className="py-24 max-w-6xl mx-auto px-6">
      ...
      <div className="space-y-16">
        {experienceData.map((item, idx) => (
          <div
            key={idx}
            className="group relative border-l-2 border-border/50 pl-8 hover:border-accent transition-colors"
          >
