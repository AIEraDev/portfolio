        ...
        <section id="hero" className="text-center mb-20 animate-fade-in" itemScope itemType="https://schema.org/Person">
          <div className="mb-8">
            <div className="relative inline-block">
              <Image src="https://avatars.githubusercontent.com/u/80651195" alt="Abdulkabir Musa (AIEraDev) - Full-Stack Developer Profile Photo" width={120} height={120} className="rounded-full mx-auto ring-4 ring-gray-100 dark:ring-gray-800 hover:ring-blue-200 dark:hover:ring-blue-800 transition-all duration-300 hover:scale-105" priority itemProp="image" />
              <div className="absolute -bottom-1 -right-1 w-8 h-8 bg-green-500 rounded-full border-4 border-white dark:border-gray-900 animate-pulse" title="Available for work"></div>
            </div>
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 animate-slide-up" itemProp="jobTitle">
              <span className="bg-gradient-to-r from-cyan-500 via-purple-500 to-blue-500 bg-clip-text text-transparent font-semibold">Full-Stack Engineer — Next.js · Node.js · Systems & API Design</span>
            </p>
            <meta itemProp="alternateName" content="AIEraDev" />
            <meta itemProp="email" content="musaabdulkabeer19@gmail.com" />
        ...
        <section id="about" className="mb-20 animate-fade-in-delay" itemScope itemType="https://schema.org/AboutPage">
          ...
          <div className="space-y-4 text-gray-600 dark:text-gray-300 leading-relaxed" itemProp="about">
            <p className="hover:text-gray-800 dark:hover:text-gray-100 transition-colors duration-300 relative">
              ...
              I'm Abdulkabir Musa, also known as <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent font-semibold">AIEraDev</span>, a forward-thinking Full-Stack Engineer experienced in building production web and mobile systems with Next.js, Node.js, and TypeScript. I design secure API proxies, OAuth2 client-credentials flows, token caching (Redis), and performant client apps that support Arabic/RTL text and Quran audio.
            </p>
            <p className="hover:text-gray-800 dark:hover:text-gray-100 transition-colors duration-300 relative">
              <span className="absolute -left-4 top-0 w-1 h-full bg-gradient-to-b from-green-500 to-blue-500 rounded-full opacity-30"></span>
              I've built DeenMinder to production for a client and shipped multiple consumer-facing features including alarms, audio streaming, and word-by-word Quran functionality. I'm passionate about delivering dependable, well-documented, and maintainable engineering solutions that solve real-world problems.
            </p>
          </div>
        </section>
      ...
      <footer className="border-t border-gray-200 dark:border-gray-700 py-8 bg-gradient-to-r from-purple-50 via-pink-50 to-red-50 dark:from-gray-800 dark:via-purple-900 dark:to-violet-900">
        <div className="max-w-2xl mx-auto px-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            <a href="mailto:musaabdulkabeer19@gmail.com" className="text-sm bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent hover:from-blue-600 hover:to-purple-600 transition-all duration-200 font-medium">
              musaabdulkabeer19@gmail.com
            </a>
          </div>
        </div>
      </footer>
