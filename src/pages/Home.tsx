          ...
          <section id="systems" className="section-rule py-24 max-w-6xl mx-auto px-6">
            ...
            <div className="space-y-0">
              {SYSTEMS.map((system, i) => (
                <SystemItem key={i} {...system} />
              ))}
            </div>

            <div className="mt-12 text-center">
              <a href="https://github.com/AIEraDev?tab=repositories" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-muted-foreground hover:text-accent transition-colors group">
